...
const testimonials = [
  {
    ...
    company: "TechCorp",
    testimonial:
      "Booking rides has never been easier! I can request a car within seconds and it always arrives on time. Safe and reliable — I use it every day to get to work.",
    avatar: user6,
  },
  {
    id: 2,
  ...
  return (
    <div className="w-full flex justify-center items-center py-12 px-6">
      <div className="w-full">
        <h2 className="mb-14 text-3xl md:text-4xl font-bold text-center tracking-tight">
          What people think
        </h2>
...
const TestimonialCard = ({
  ...
  <div className="mb-8 bg-accent rounded-xl py-8 px-6 sm:py-6">
    <div className="flex items-center justify-between gap-20">
      <div className="hidden lg:block relative shrink-0 aspect-[3/4] max-w-[18rem] w-full bg-red-500 rounded-xl">
        <img src={testimonial.avatar} alt="" className="w-full h-full" />
      ...
      <div className="flex flex-col justify-center">
        <div className="flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1">
            <StarIcon className="w-5 h-5 fill-orange-500 stroke-orange-500" />
            <StarIcon className="w-5 h-5 fill-orange-500 stroke-orange-500" />
            <StarIcon className="w-5 h-5 fill-orange-500 stroke-orange-500" />
            <StarIcon className="w-5 h-5 fill-orange-500 stroke-orange-500" />
            <StarIcon className="w-5 h-5 fill-orange-500 stroke-orange-500" />
